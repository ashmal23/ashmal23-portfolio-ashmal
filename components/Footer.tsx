        ...
        <footer className="bg-bg-primary pt-16 sm:pt-20 border-t border-border/50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex space-x-4">
                            <a
                                href="https://github.com/ashmal23"
                                target="_blank"
                            ...
                            <a
                                href="https://www.linkedin.com/in/ashmal-ahmed-988776347"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 glass rounded-lg flex items-center justify-center hover:shadow-[0_0_15px_var(--color-glow)] hover:-translate-y-1 transition-all group border-border/30"
                                title="LinkedIn"
            ...
            <div className="border-t border-border/30 bg-bg-primary/50 py-6">
                <div className="container mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center text-xs text-text-secondary font-medium tracking-wider space-y-2 md:space-y-0 text-center">
                    <p>© 2026 ASHMAL AHMED</p>
                    <p className="flex items-center">
                        DESIGNED & BUILT WITH <span className="text-accent-primary mx-1.5 animate-pulse text-sm">❤️</span> BY ASHMAL AHMED
                    </p>
                </div>
            </div>
        </footer>
